...
\section*{Análise}
Ao calcularmos manualmente usando somente os cronômetros, obtivemos resultados 
parecidos com os calculados através do programa usando as tabelas \textit{.csv}. 
Tão parecidos que o erro sempre tendia a 0.
